...
This version of the layout communicates directly with D::Light

TouchOSC Setup
	
	Network :
		Host				: IP address of the computer running D::Light
		Port (outgoing)		: 7000
		Port (incomming)	: 7001 
...
Cette version communique directement avec D::Light

Configuration TouchOSC
	
	Network :
		Host				: adresse IP de l'ordinateur exécutant D::Light
		Port (outgoing)		: 7000
		Port (incomming)	: 7001 

Configuration de D::Light
